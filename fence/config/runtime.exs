...
#
#     PHX_SERVER=true bin/fence start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :fence, FenceWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :fence, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :fence, FenceWeb.Endpoint,
    ...
    live_view: [signing_salt: "sFk3Vbx7"],
    check_origin: [
      "https://#{host}",
      "https://*.#{host}"
    ]
