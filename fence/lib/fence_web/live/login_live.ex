    ...
    <div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-700 to-purple-900 px-4">
      <div class="w-full max-w-sm rounded-lg bg-white p-8 shadow-lg">
        ...
        <form action="/web/auth/login" method="post" class="space-y-4">
          ...
          <button
            type="submit"
            class="w-full rounded-lg bg-purple-600 px-4 py-2 text-sm font-semibold text-white shadow-lg hover:bg-purple-700"
          >
            Sign In
          </button>
        </form>
        ...
        <p class="mt-4 text-center text-sm text-gray-500">
          ...
          <a href="/web/register" class="text-purple-600 hover:underline">Register</a>
        </p>
      </div>
    </div>
    """
